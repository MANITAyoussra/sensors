...
void loop() {
  ...
  readSwitch();
  String localtimedate=Getlocaltimedate();
 ...
 String serverName = "http://192.168.1.203/test/testwsbt.php?statut="+Value+"localtimedate"+localtimedate ;
...
{ 
  while (WiFi.status()== WL_CONNECTED){
   ...
   {
    Value=tableau[i]+Getlocaltimedate();
    inf=i;}
  }
...
String Getlocaltimedate(){
 ...
 // Serial.println(currentDate);
  ...
  String s=String(currentDate)+"---" +String(formattedTime);
  return (s);
