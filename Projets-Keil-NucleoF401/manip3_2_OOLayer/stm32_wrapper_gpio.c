...
/*      - Translates OO Pin Represetation (Px_i) to ST HAL Lib  */
/*      - And Calls ST HAL Library Functions                    */
/*--------------------------------------------------------------*/
	...
	int gpio_read(PinName pin)
{
		...
		return HAL_GPIO_ReadPin(GPIOx,gpioPIN);
}
...
/*      - Translates OO Pin Represetation (Px_i) to HAL FWL      */
/*      - And Calls ST HAL Library Functions                     */
/*================================================================*/
static void _gpio_init_out(PinName pin, PinOutMode mode, PinSpeed speed)
{
	...
	/*=======Fills GPIO Structure==========*/
		
		//Pin and Resistor Pull Up/Down
		GPIO_InitStruct.Pin = ........
	...
	//	and Calls GPIO_Init (ST HAL Lib)
		.........................................;		
	}
