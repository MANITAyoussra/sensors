...
public:
     ...
     */
		xxPinAsOutput(PinName pin) :thepin(pin) { 
...
/***** Create a PinAsOutput connected to the specified pin
     ...
     */
    xxPinAsOutput(PinName pin, PinOutMode mode):thepin(pin) {
...
/***** Create a PinAsOutput connected to the specified pin
     ...
     *  @param mode the initial mode of the pin
     */
    xxPinAsOutput(PinName pin, PinOutMode mode, PinSpeed speed):thepin(pin) {
